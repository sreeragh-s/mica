        ...
        <form className="space-y-10" onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <div className="size-8 rounded-full bg-amber-100 p-2 dark:bg-slate-800">
                <Sun className="size-4 text-amber-600 dark:hidden" />
                <Moon className="hidden size-4 text-slate-200 dark:block" />
              </div>
