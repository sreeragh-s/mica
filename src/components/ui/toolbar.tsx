...
const toolbarButtonVariants = cva(
  "inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium outline-none transition-[color,box-shadow] hover:bg-muted hover:text-muted-foreground focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 aria-checked:bg-accent aria-checked:text-accent-foreground aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    ...
    variants: {
      size: {
        default: 'h-9 min-w-9 px-2 text-sm [&_svg:not([class*=\'size-\'])]:size-4',
        lg: 'h-10 min-w-10 px-2.5 text-sm [&_svg:not([class*=\'size-\'])]:size-4',
        sm: 'h-8 min-w-8 px-1.5 text-xs [&_svg:not([class*=\'size-\'])]:size-3.5',
        xs: 'h-7 min-w-7 px-1.5 text-[11px] [&_svg:not([class*=\'size-\'])]:size-3',
