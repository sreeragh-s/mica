...
export const AppSidebar = React.memo(function AppSidebar({
  ...
  const sidebarBody = React.useMemo(() => {
  ...
  }, [activeView, workspace, settingsPanel, onSettingsPanelChange, explorerContent])
      ...
      <div className="flex min-h-0 flex-1">
        ...
        <div className="flex min-h-0 min-w-0 flex-1 flex-col">
          ...
          <div className={!isWorkspaceView ? "flex flex-col flex-1 min-h-0" : "hidden"}>
            <SidebarContent className="min-h-0 bg-sidebar flex-1">
              <TooltipProvider>
                <div className="bg-sidebar text-sidebar-foreground h-full">{sidebarBody}</div>
              </TooltipProvider>
            </SidebarContent>
          </div>
        </div>
