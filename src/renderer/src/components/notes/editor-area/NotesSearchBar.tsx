...
import type { NoteSearchResult, SearchMatchSegment } from '@/lib/notes/notes-search'
import { searchNotes } from '@/lib/notes/notes-search'
import type { SavedNote, Folder } from '@/lib/notes/notes-storage'

import { liquidGlassControlPillClass, liquidGlassSearchShellClass } from '@/lib/platform/liquid-glass-toolbar'
