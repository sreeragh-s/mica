...
import { EditorFindPlugin } from '@/features/editor/plugins/editor-find-plugin'
...
import { ImageSourceTabs, ImagesPlugin } from '@/features/editor/plugins/images-plugin'
...
function TitleEmojiPickerContent({ onPick }: { onPick: (emoji: string) => void }) {
  return (
    <EmojiPicker.Root
...
export function Plugins({
  ...
  const [isFloatingLinkEditorOpen, setIsFloatingLinkEditorOpen] = useState(false)
          ...
          contentEditable={
            <div className="relative flex min-h-0 flex-1 flex-col">
                    ...
                    <div className="relative">
                      <ContentEditable
                        ...
                        className={cn(
                          ...
                          showTopMediaBar || (onTitleEmojiChange && titleEmoji) ? 'pt-2' : 'pt-4'
                        )}
                      />
                    </div>
                  </div>
              ...
              <div className="pointer-events-none absolute inset-x-0 top-2 z-50 flex justify-center px-4">
                <div className="pointer-events-auto flex w-full max-w-4xl justify-end pr-2">
                  <EditorFindPlugin anchorElem={floatingAnchorElem} />
                </div>
              </div>
            </div>
          }
