...
export function NotesGraphView({
  ...
  const linkSelRef = useRef<d3.Selection<SVGLineElement, d3.SimulationLinkDatum<SimNode>, SVGGElement, unknown> | null>(null)
  ...
  const graph = useMemo(() => {
    ...
    if (localMode && localCenter) {
      ...
      links = links.filter(
        (l) => neighbourIds.has(l.source) && neighbourIds.has(l.target)
      )
    }
  ...
  useEffect(() => {
    ...
    const simulation = d3
      ...
      .force("collide", d3.forceCollide<SimNode>().radius((d) => nodeRadius(d as SimNode) + f.collide))
      .alphaDecay(0.025)
        ...
        >
          ...
          >
            ...
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M5 3a1 1 0 1 0 0 2 1 1 0 0 0 0-2ZM2 4a3.001 3.001 0 0 1 5.83-.5H14a.5.5 0 0 1 0 1H7.83A3.001 3.001 0 0 1 2 4ZM10 8a1 1 0 1 0 0 2 1 1 0 0 0 0-2ZM1 8.5a.5.5 0 0 1 .5-.5h5.67a3.001 3.001 0 0 1 5.66 0H14.5a.5.5 0 0 1 0 1h-1.67a3.001 3.001 0 0 1-5.66 0H1.5a.5.5 0 0 1-.5-.5ZM5 11a1 1 0 1 0 0 2 1 1 0 0 0 0-2ZM2 12a3.001 3.001 0 0 1 5.83-.5H14.5a.5.5 0 0 1 0 1H7.83A3.001 3.001 0 0 1 2 12Z" fill="currentColor" fillRule="evenodd" clipRule="evenodd"/>
            </svg>
          </button>
        </div>
      )}
        ...
        {showPanel && (
          <div className="bg-background/96 border-border absolute bottom-8 right-2 z-20 w-60 overflow-hidden rounded-xl border shadow-xl backdrop-blur-md">
            ...
            <div className="border-border border-b px-3 pt-3 pb-2">
              <p className="text-foreground mb-2 text-[11px] font-semibold uppercase tracking-wider opacity-60">Forces</p>
            ...
            <div className="px-3 pt-2 pb-3">
              <p className="text-foreground mb-2 text-[11px] font-semibold uppercase tracking-wider opacity-60">Display</p>
              ...
              <div className="mt-1 flex flex-col gap-1.5">
                {(
                  ...
                  <label key={key} className="text-muted-foreground flex cursor-pointer items-center gap-2 text-xs">
                    <input
                      type="checkbox"
                  ...
                  <div className="flex flex-col gap-1">
                    {folders.map((f, i) => (
                      <div key={f.folder} className="flex items-center gap-1.5">
                        ...
                        />
                        <span className="text-muted-foreground truncate text-xs">{f.folder || "(root)"}</span>
                      </div>
                    ))}
                  </div>
                </div>
